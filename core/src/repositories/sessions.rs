...
use crate::{models::user_session::{Session, SessionFilter, InsertSession, SessionClient, SessionUser}, drivers, Error, sql::{ConditionalInsert, SessionIden, UserIden}};

pub mod traits {
    use futures::{stream::BoxStream, future::BoxFuture};

    use crate::{models::user_session::{SessionFilter, Session, InsertSession}, Error, drivers};
...
mod sql_query {
    ...
    use crate::models::user_session::{InsertSession, Session};
