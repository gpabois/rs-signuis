...
pub mod traits {
    ...
    pub trait CredentialRepository<'q>: Sized + std::marker::Send {
        ...
        fn find_credentials_by<'a, 'b, Q: drivers::DatabaseQuerier<'b>>(
            self,
            querier: Q,
        ...
        fn find_one_credential_by<'a, 'b, Q: drivers::DatabaseQuerier<'b>>(
            self,
            querier: Q,
            filter: CredentialFilter,
...
mod sql_query {
    ...
    pub fn find_credentials_by(filter: CredentialFilter) -> (String, SqlxValues) {
        Query::select()
            ...
            .conditions(
                filter.name_or_email_eq.is_some(),
                |s| {
...
impl Repository {
    pub fn find_credentials_by(&self, filter: &CredentialFilter) {}
}
