...
use signuis_core::{model::session::{Client, InsertSession, Session}, services::ServiceTx, repositories::sessions::traits::SessionRepository, Error};
use sqlx::Acquire;
...
pub struct SessionFixture {
    ...
    user_id: Option<ForeignKeyFixture<String, UserFixture>>,
...
impl SessionFixture {
    ...
    pub fn with_user_id<F: Into<ForeignKeyFixture<String, UserFixture>>>(mut self, value: F) -> Self {
